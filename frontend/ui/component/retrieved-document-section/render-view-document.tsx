        ...
        <div key={doc.id} className="border border-gray-200 rounded-lg p-4 bg-white shadow-sm">
            <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex items-center gap-2 ml-4">
                    <button
                        ...
                        className="p-1.5 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded transition-colors hover:cursor-pointer"
                        title="Copy content"
                    >
                        {copiedDoc === doc.id ? (
            ...
            <div className="bg-gray-50 rounded-md p-3">
                ...
                {!isExpanded && doc.content.length > 200 && (
                    <button
                        onClick={() => toggleExpanded(doc.id)}
                        className="mt-2 text-blue-600 hover:text-blue-900 text-sm font-medium hover:cursor-pointer"
                    >
                        Show more
                    </button>
                )}
